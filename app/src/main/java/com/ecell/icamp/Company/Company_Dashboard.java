...
public class Company_Dashboard extends AppCompatActivity {
    ...
    private Company_Dashboard.SectionsPagerAdapter mSectionsPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSectionsPagerAdapter = new Company_Dashboard.SectionsPagerAdapter(getSupportFragmentManager());
        ...
        bottomNavigation.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                switch (id){
                    case R.id.db_student: fragmentChange(0); break;
                    case R.id.db_company: fragmentChange(1); break;
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0: return new Fragment_Student_List();
    ...
    static void fragmentChange(int position) {
